...
from tools.data_converter import rope3d_converter as rope3d
...
def rope3d_data_prep(root_path,
                    info_prefix,
                    version,
                    out_dir,
                    with_plane=False):
    """Prepare data related to Rope3D dataset.
    ...
    rope3d.export_2d_annotation(root_path, info_val_path)
